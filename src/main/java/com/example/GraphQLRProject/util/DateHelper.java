...
public class DateHelper {
	 ...
	 * @param dateFormat - Formato de representação da data que deve ser utilizado
	 *                   na string;
	...
	/**
	 * 
	 * @param date - Data usada como base para o incremento/decremento dos dias
	 *             informados;
	 * @param days - Quantidade de dias que deverão ser acrescidos/decrescidos da
	 *             data informada; O parâmetro ´days` pode ser negativo, no caso de
	 *             um decremento de dias;
	...
	/**
	 * 
	 * @param date   - Data usada como base para o incremento/decremento dos meses
	 *               informados;
	 * @param months - Quantidade de meses que deverão ser acrescidos/decrescidos da
	 *               data informada; O parâmetro ´months` pode ser negativo, no caso
	 *               de um decremento de meses;
	...
	/**
	 * 
	 * @param date  - Data usada como base para o incremento/decremento dos anos
	 *              informados;
	 * @param years - Quantidade de anos que deverão ser acrescidos/decrescidos da
	 *              data informada; O parâmetro ´years` pode ser negativo, no caso
	 *              de um decremento de anos;
