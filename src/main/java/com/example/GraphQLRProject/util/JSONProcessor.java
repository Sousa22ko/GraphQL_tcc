...
public class JSONProcessor {
	...
	/**
	 * Converte uma string JSON para um objeto de uma determinada classe com o
	 * formato de data à ser usado passado como parâmetro.
	 *
	 * @param <T>        Tipo de retorno
	 * @param jsonText   JSON a se converter
	 ...
	 */
	public synchronized static <T> List<T> toList(String jsonText, Class<T> clazz, String... params)
			throws JSONException {
